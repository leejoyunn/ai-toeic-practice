...
export const listeningImageSchema=z.object({id:z.string().min(1),imageUrl:z.string().min(1),description:z.string().min(10),tags:z.array(z.string()),scene:z.string().min(1),objects:z.array(z.string()),actions:z.array(z.string()),isActive:z.boolean()});
